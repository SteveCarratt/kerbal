...
var _ = require('lodash'),
    ...
    inclinationChange = require("../lib/inclination-change.js");
    orbitalVelocity = require("../lib/orbital-velocity.js");
...
var sectionHandlers = {
    ...
    "adjust-inclination" : function(section, craftState){
        "use strict";
        var velocity = orbitalVelocity(craftState.parentBody, section.parentBodyDistance, craftState.apoapsis);
        craftState.deltaVUsed = inclinationChange(section.angleChange, velocity);
        return craftState;
    }
};
